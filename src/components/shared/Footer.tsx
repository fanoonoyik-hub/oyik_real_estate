...
const socialLinks = [
  ...
  { 
    ...
    icon: (props: any) => (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M12 3c-1.3 0-2.4.5-3.5 1.4-1.1.9-1.9 2.1-1.9 3.6 0 1.2.4 2.1 1.2 2.8.2.2.4.4.4.6 0 .4-.6.8-1.2 1.2-1.2.8-2 1.6-2 3.4 0 .9.4 1.7 1.1 2.4.7.7 1.8 1.1 3 1.1.7 0 1.4-.1 2-.4.6.3 1.3.4 2 .4 1.2 0 2.3-.4 3-1.1s1.1-1.5 1.1-2.4c0-1.8-.8-2.6-2-3.4-.6-.4-1.2-.8-1.2-1.2 0-.2.2-.4.4-.6.8-.7 1.2-1.6 1.2-2.8 0-1.5-.8-2.7-1.9-3.6C14.4 3.5 13.3 3 12 3z" />
        <path d="M5 19c0-1.5.5-2.5 1.5-3.5" />
        <path d="M19 19c0-1.5-.5-2.5-1.5-3.5" />
      </svg>
    ),
